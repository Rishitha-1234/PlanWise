    ...
    <div className="bg-[#111111] p-6 rounded-2xl shadow-lg w-auto text-white font-sans min-h-90">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
            <select
            className="bg-[#1c1c1c] flex items-center gap-1 text-sm text-gray-300 px-1 py-2 rounded-lg border border-gray-700 cursor-pointer hover:border-gray-500 focus:outline-none focus-visible:outline-none focus:ring-0 transition-all duration-150"
            defaultValue="recent"
            >
            ...
            {/* Tooltip on Hover for the + button */}
            <TooltipProvider>
            <Tooltip>
      ...
      <div className="space-y-4 mb-6">
        {[1, 2, 3].map((num) => (
          <div key={num} className="flex items-center gap-8">
            ...
            <span className="text-white cursor-pointer">Project -{num}</span>
          </div>
        ))}
        </div>
